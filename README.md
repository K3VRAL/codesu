...
<a name='install'></a>
## Installation
The already compiled binaries for Linux (sorry Windows users) in 64-bit and 32-bit versions should be in the [releases](https://github.com/K3VRAL/codesu/releases) webpage.
